...
project = 'Launch Interceptor Program - Group 24'
copyright = '2024 Casper K, Andreas H, Martin L, Victor Ö, Adam S'
author = 'Casper Kristiansson (casperkr@kth.se), Andreas Hammarstrand (aeha@kth.se), Martin Lindefors (lindefor@kth.se), Victor Österman (vios@kht.se), Adam Sjöberg (adamsjo@kth.se)'
release = '1.0'
